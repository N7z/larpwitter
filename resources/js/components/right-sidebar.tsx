    ...
    return (
        <div className="sticky top-6 space-y-4">
            <section className="overflow-hidden rounded-lg border border-gray-200 bg-white">
                <h2 className="border-b border-gray-200 px-4 py-3 text-sm font-bold text-gray-900">New users</h2>
                {newUsers.length === 0 ? (
                    <p className="px-4 py-3 text-sm text-gray-500">No users yet.</p>
                ) : (
                    newUsers.map((user) => (
            ...
            <section className="overflow-hidden rounded-lg border border-gray-200 bg-white">
                <h2 className="border-b border-gray-200 px-4 py-3 text-sm font-bold text-gray-900">Trending</h2>
                {trendingHashtags.length === 0 ? (
                    <p className="px-4 py-3 text-sm text-gray-500">Nothing trending yet.</p>
                ) : (
                    trendingHashtags.map((hashtag) => (
                        ...
                        >
                            ...
                            <div className="min-w-0">
                                <p className="truncate text-sm font-semibold text-gray-900">#{hashtag.name}</p>
